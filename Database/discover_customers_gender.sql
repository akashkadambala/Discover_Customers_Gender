...
--
-- Host: localhost
-- Generation Time: Jan 17, 2023 at 12:14 PM
...
--
-- Database: `discover_customers_gender`
--
CREATE DATABASE IF NOT EXISTS `discover_customers_gender` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `discover_customers_gender`;
...
('42kioy0x83h1i8bxwi4dstiydta4mb6r', 'eyJ1c2VyaWQiOjN9:1pHkHx:RmoZVwd2WCqACqRg9nELNgW8UYIDYpSF2ZHcSLyjdcE', '2023-01-31 11:38:01.889500'),
...
('8x9yzearhvw62a8cjrcapop65pr4rl48', 'eyJ1c2VyaWQiOjN9:1pHkLL:URPit3znHrPy1fvxs5kgp4MTYdBRRxf8vyZ_GT9p6lM', '2023-01-31 11:41:31.313479'),
...
('ystn4qyftbbolcy0vt0oz4ea8tmjt6t3', 'eyJ1c2VyaWQiOjN9:1pHima:X9mH-18ufd3PGtULYXkisQPPX8LbWPH0VP5jEa4qzAM', '2023-01-31 10:01:32.050125'),
...
('zo27jsipxkvqd2s8mw5jysj55ehqe3r1', 'eyJ1c2VyaWQiOjR9:1pHklH:vpSpglYY4OpQK5TSfchPB8rtpxABZFHCSfwYhoapOqU', '2023-01-31 12:08:19.696286');
...
(3, 'Ramesh', 'Ramesh123@gmail.com', 'Ramesh', '9535866270', 'India', 'Karnataka', 'Bangalore', '#8928,4th Cross,Rajajinagar', 'Male'),
...
(63, 'Naive Bayes', '51.73116089613035'),
(64, 'SVM', '50.71283095723014'),
(65, 'Logistic Regression', '49.287169042769854'),
(66, 'Decision Tree Classifier', '48.26883910386965'),
(67, 'Gradient Boosting Classifier', '51.32382892057027'),
(68, 'Random Forest Classifier', '50.71283095723014');
...
(21, 'Female Customer', '50.0'),
(22, 'Male Customer', '50.0');

-- --------------------------------------------------------

--
-- Table structure for table `remote_user_gender_prediction`
--

CREATE TABLE IF NOT EXISTS `remote_user_gender_prediction` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `date_time` varchar(3000) NOT NULL,
  `event_name` varchar(3000) NOT NULL,
  `product_id` varchar(3000) NOT NULL,
  `category_id` varchar(3000) NOT NULL,
  `category_name` varchar(3000) NOT NULL,
  `brand` varchar(3000) NOT NULL,
  `price` varchar(3000) NOT NULL,
  `user_id` varchar(3000) NOT NULL,
  `session` varchar(3000) NOT NULL,
  `category_1` varchar(3000) NOT NULL,
  `category_2` varchar(3000) NOT NULL,
  `category_3` varchar(3000) NOT NULL,
...
--
-- Dumping data for table `remote_user_gender_prediction`
--

INSERT INTO `remote_user_gender_prediction` (`id`, `date_time`, `event_name`, `product_id`, `category_id`, `category_name`, `brand`, `price`, `user_id`, `session`, `category_1`, `category_2`, `category_3`, `Prediction`, `gender`) VALUES
(3, '2022-12-16 02:10:05+09', 'remove_from_cart', '5732026', 'xa6kwguo', 'furniture.bathroom.bath', 'domix', '4.16', '10.42.0.151-64.71.142.110-42699-80-6', '7e42059b-dacf-43b6-a9fb-ce4f34bef3bb', 'furniture', 'bathroom', 'bath', 'Male Customer', 'Male'),
(4, '2022-12-22 22:10:21+09', 'view', '5748490', 'cs8n5kid', 'appliances.environment.vacuum', 'Not defined', '26.97', '10.42.0.211-10.42.0.1-36808-53-17', '2a924110-3300-4342-ab8c-c5ee3930672c', 'appliances', 'environment', 'vacuum', 'Female Customer', 'Female'),
(5, '2022-12-22 22:48:01+09', 'view', '5774248', '5afkr3uy', 'furniture.living_room.cabinet', 'Not defined', '79.35', '10.42.0.211-10.42.0.1-16294-53-17', 'b09f9261-f972-4111-962f-b3c7f6b190db', 'furniture', 'living_room', 'cabinet', 'Female Customer', 'Female'),
(6, '2022-12-22 22:52:43+09', 'view', '5774248', 'rk1cxwz6', 'furniture.living_room.cabinet', 'Not defined', '79.35', '180.149.134.141-10.42.0.211-80-54764-6', '537aa5e6-c75a-4408-a92b-34a56af0eeb9', 'furniture', 'living_room', 'cabinet', 'Male Customer', 'Male'),
(7, '2022-12-22 23:33:26+09', 'cart', '5861760', '5yvburwy', 'appliances.environment.vacuum', 'emil', '71.43', '172.217.10.14-10.42.0.151-443-44168-6', '543f4542-7cd1-d18e-fe46-bcfb2c5410ac', 'appliances', 'environment', 'vacuum', 'Male Customer', 'Male'),
(8, '2022-12-16 07:20:11+09', 'remove_from_cart', '5732039', '28ddm9um', 'furniture.bathroom.bath', 'domix', '3.41', '10.42.0.151-10.42.0.1-25685-53-17', 'd791cf1a-0b25-4c05-ba64-5e2d652cd08a', 'furniture', 'bathroom', 'bath', 'Female Customer', 'Female');
